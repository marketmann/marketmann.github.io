...
window['ly_cid'] = "7633a10cce24ede709377546c8e3146d";
...
(function(d, w, getIdResponse) {
  ...
  w.lio = {
    account: {
      id: "7633a10cce24ede709377546c8e3146d"
    },
    loaded: false,
    ...
    fields: !!w.liosetup && w.liosetup.fields || "first_name,last_name,email,city,country_code,zip,state,address_line_1" || "",
    ...
    integrationsConfig:{
      ...
      googleAdsIntegration: [{"web_property":"UA-3366695-18","segments_dimension":"dimension12","user_id_dimension":"dimension11"}],
...
if(typeof window.jstag !== 'object'){
    ...
    initObj.cid = "7633a10cce24ede709377546c8e3146d";
